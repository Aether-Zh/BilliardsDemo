        ...
        sCocos2dxActivity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (webView != null) {
                    ...
                    mButtonBack.setImageDrawable(sCocos2dxActivity.getResources().getDrawable(R.drawable.btn_x_back));
                    mButtonBack.setBackgroundColor(0);
                    
                    FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(FrameLayout.LayoutParams.WRAP_CONTENT,
                            FrameLayout.LayoutParams.WRAP_CONTENT);
                    layoutParams.width = convertPixelToDip(78);
                    layoutParams.height = convertPixelToDip(78);
